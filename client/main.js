document.addEventListener('DOMContentLoaded', e => {
    ...
    const player1 = new Player(new Position(playerMargin, s.mid.y - playerHeight / 2), new RectangularDimensions(playerWidth, playerHeight), new Color(10, 20, 70, 255))
    const player2 = new Player(new Position(s.width - playerMargin - playerWidth, s.mid.y - playerHeight / 2), new RectangularDimensions(playerWidth, playerHeight), new Color(70, 20, 10, 255))
